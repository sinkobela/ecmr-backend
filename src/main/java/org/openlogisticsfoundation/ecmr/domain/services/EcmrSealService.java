...
public class EcmrSealService {
    ...
    public void sealEcmr(UUID ecmrId, SealCommand sealCommand, InternalOrExternalUser internalOrExternalUser)
        ...
        Optional<SealedDocumentEntity> sealedDocumentOpt = sealedDocumentService.getSealedDocumentEntity(ecmrId, internalOrExternalUser);
        SealedDocumentEntity sealedDocument;
        if (sealedDocumentOpt.isPresent()) {
            sealedDocument = sealedDocumentOpt.get();
            sealedDocumentService.validateSealedDocument(sealedDocument);
        } else {
    ...
    private SealedDocumentEntity createSeal(SealedDocumentEntity sealedDocumentEntity, SealCommand sealCommand, String sealer) {
        ...
        String seal = signerService.sign(claims, sealedDocumentService.getCurrentSeal(sealedDocumentEntity));
        ...
        return sealedDocumentService.saveSealedDocument(sealedDocumentEntity);
    }

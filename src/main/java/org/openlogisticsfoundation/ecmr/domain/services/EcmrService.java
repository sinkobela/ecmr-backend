...
public class EcmrService {
    ...
    public List<EcmrModel> getEcmrsForUser(EcmrType type) {
    ...
    public void deleteEcmr(UUID ecmrId) throws EcmrNotFoundException {
        ...
        if (ecmrEntity != null && ecmrEntity.getCarrierInformation().getSignature() == null && ecmrEntity.getSenderInformation().getSignature() == null
                && ecmrEntity.getConsigneeInformation().getSignature() == null && ecmrEntity.getSuccessiveCarrierInformation().getSignature() == null && ecmrEntity.getEcmrStatus() == EcmrStatus.NEW) {
